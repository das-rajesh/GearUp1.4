                ...
                <form:form method="post" action="/POS/update" modelAttribute="tempChildListWrapper">
                    <c:forEach varStatus="us" var="user" items="${tempChildListWrapper.users}" >
                        <tr>
                            ...
                            <td><form:input type="hidden" path="users[${us.index}].price"/> ${user.price}</td>
                            <td><form:input type="hidden" path="users[${us.index}].quantity"/>${user.quantity}</td>
<!--                            <td><form:input type="hidden" path="users[${us.index}].id"/>${user.id}</td>-->

                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <form method="post" action="/POS/change/${evenCount}">
                            ...
                            <form:input path="tempChild[${evenCount}].name" name="name" id="name" value="${tempChild.name}" />

                            <td><div class="quantity">
                                    <input type="number" name="quantity" min="1" max="${tempChild.quantity}" step="1" value="${tempChild.quantity}">
                                </div>
                            </td>    
                            <form:input path="tempChild[${evenCount}].quantity" name="quantity" id="quantity" value="${tempChild.quantity}" />

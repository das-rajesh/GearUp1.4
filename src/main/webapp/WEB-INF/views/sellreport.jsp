    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="/admin/salereports">Download</a></li>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $.getJSON("/admin/api/sellreport", function (res) {
                    $.each(res, function (i, resp) {
                        ...
                        $("<td/>").html(resp.sizeId.childSubCategoriesId.vendorId.name).appendTo($tr);
                        ...
                        $("<td/>").html(resp.sizeId.size).appendTo($tr);
                          $("<td/>").html(resp.sizeId.childSubCategoriesId.price).appendTo($tr);
                        $("<td/>").html(resp.sizeId.quantity).appendTo($tr);

                           $("<td/>").html(resp.sizeId.quantity * resp.sizeId.childSubCategoriesId.price).appendTo($tr);

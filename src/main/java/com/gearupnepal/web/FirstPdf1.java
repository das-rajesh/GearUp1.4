...
public class FirstPdf1 {
    ...
    private static String FILE = "C:\\Users\\admin\\Pictures\\sale.pdf";
    ...
    private static void addContent(Document document) throws DocumentException, BadElementException, IOException {
        ...
        // add a table
        firstPdf1.createTable(subCatPart);
    ...
    private void createTable(Section subCatPart)
        ...
        table.addCell("2.1");
        table.addCell("2.2");
        for(Purchase purchase:purchaseService.getAll()){
            System.out.println(purchase.getCategory()+"category");
        }
        try {
    ...
    public void table(Section subCatPart) throws BadElementException, IOException {

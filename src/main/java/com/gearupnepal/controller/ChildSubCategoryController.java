 ...
 */
@Controller
@RequestMapping(value = "/admin/childsubcategory")
...
//        model.addAttribute("category", categoryService.findById(id2).getName());
        ...
        return "redirect:/admin/childsubcategory";
    }
    ...
    public String delete(@PathVariable("id") long id) {
        childSubcategoryService.delete(id);
        return "redirect:/admin/childsubcategory2";
    }
